    ...
    <div class="form">
        ...
        >
            <div class="sidebar">
                ...
                <form-slider label="Guidance (CFG)"        prop="cfgScale"        v-model="store.params.cfg_scale"                 :min="store.minCfgScale"      :max="store.maxCfgScale"   :step="0.5"  info="Classifier Free Guidance (CFG Scale). Higher values will make the AI respect your prompt more. Lower values allow the AI to be more creative." v-else-if="store.multiSelect.guidance.state === 'Enabled'" />
                ...
                <form-slider label="Flow Shift"            prop="flowShift"       v-model="store.params.flow_shift"              :min="store.minFlowShift"     :max="store.maxFlowShift"    :step="0.5"  info="override shift value for flow models" v-if="store.multiSelect.flowShift.state === 'Enabled'" />
